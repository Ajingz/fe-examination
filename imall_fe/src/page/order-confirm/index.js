...
* @Last Modified time: 2017-09-12 17:50:24
*/
'use strict';
require('./index.css');
...
var page = {
	...
	loadAddressList :function(){
		...
		_address.getAddressList(function(res){
			...
			var AddressListHtml = _im.renderHtml(templateAddress,res);
	...
	loadProductList :function(){
		...
		_order.getProductList(function(res){
			var ProductListHtml = _im.renderHtml(templateProduct,res);
